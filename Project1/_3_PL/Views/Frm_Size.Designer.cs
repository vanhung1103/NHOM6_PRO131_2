namespace _3_PL.Views
{
    partial class Frm_Size
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_add = new Button();
            dtg_size = new DataGridView();
            Column1 = new DataGridViewTextBoxColumn();
            Column2 = new DataGridViewTextBoxColumn();
            ((System.ComponentModel.ISupportInitialize)dtg_size).BeginInit();
            SuspendLayout();
            // 
            // label2
            // 
            ...
            // dtg_size
            // 
            dtg_size.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dtg_size.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dtg_size.Columns.AddRange(new DataGridViewColumn[] { Column1, Column2 });
            dtg_size.Location = new Point(34, 142);
            dtg_size.Margin = new Padding(2);
            dtg_size.Name = "dtg_size";
            dtg_size.RowHeadersWidth = 62;
            dtg_size.RowTemplate.Height = 33;
            dtg_size.Size = new Size(288, 180);
            dtg_size.TabIndex = 11;
            dtg_size.CellClick += dtg_size_CellClick;
            // 
            // Column1
            // 
            ...
            Controls.Add(dtg_size);
            Margin = new Padding(2);
            Name = "Frm_Size";
            Text = "Frm_Size";
            Load += Frm_Size_Load;
            ((System.ComponentModel.ISupportInitialize)dtg_size).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
